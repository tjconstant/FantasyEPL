...
for(plotRun in 1:2){
  ...
  if(plotRun == 2){
cairo_pdf(filename=paste("withHooper/plots/cumGraphGW",max(x),".pdf",sep=""),width=6,height=6)
  }

maximum.points<-max(c(table.breast$OP,table.chrisfc$OP,table.constormfc$OP,table.hubbins$OP,table.hungover$OP,table.leopards$OP,table.panda$OP,table.pubbandits$OP,table.thales$OP,table.hooper$OP),na.rm=T)
minimum.points<-min(c(table.breast$OP,table.chrisfc$OP,table.constormfc$OP,table.hubbins$OP,table.hungover$OP,table.leopards$OP,table.panda$OP,table.pubbandits$OP,table.thales$OP,table.hooper$OP),na.rm=T)
...
points(x,table.hooper$OP,pch=16,col=10);lines(x,table.hooper$OP,col=10)
